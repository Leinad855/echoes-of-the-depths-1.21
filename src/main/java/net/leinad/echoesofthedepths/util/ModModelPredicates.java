...
public class ModModelPredicates {
    public static void registerModelPredicates() {
        ...
        ModelPredicateProviderRegistry.register(ModItems.RESONITE_AXE, Identifier.of(EchoesOfTheDepths.MOD_ID, "charged"),
                (stack, world, entity, seed) -> stack.get(ModDataComponentsType.CHARGE) != null
                        && stack.get(ModDataComponentsType.CHARGE) == ResoniteAxeItem.MAX_CHARGE ? 1f : 0f);
    }
}
